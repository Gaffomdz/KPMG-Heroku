...
import { passCall } from '../../utils/servercall'



export async function passCodePromptE() {
    let code: string
    ...
    let button1 = cinemaKeyPadPrompt.addButton(
        ...
        async () => {
            ...
            movePlayerToVector3(new Vector3(16.71, 1.28, 10.06),new Vector3(15.92, 1.28, 19.20),)
            passwortd1Input.visible = false
            cinemaKeyPadPrompt.hide()
        },
