...
class BankInstance extends Scene {
    //environment
    ...
    constructor() {
        super(SceneLocations.Bank)
        this.addComponent(new GLTFShape('models/bank/kpmg_bank_collider_11.glb'))
        this.bankMainGeo.addComponent(new GLTFShape('models/bank/kpmg_bank_main_geo_6.glb'))
        this.bankExitDoor.addComponent(new GLTFShape('models/bank/kpmg_bank_exit_door_1.glb'))
        this.bankAnimatedObject.addComponent(new GLTFShape('models/bank/kpmg_bank_animated_object_1.glb'))
...
export const Bank= new BankInstance()