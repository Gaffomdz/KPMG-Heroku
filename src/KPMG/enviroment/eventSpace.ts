...
class EventInstance extends Scene {
    //Environment
    ...
    constructor() {
        super(SceneLocations.Event)
        this.addComponent(new GLTFShape('models/eventSpace/kpmg_events_collider_1.glb'))
        this.eventSpaceMainGeo.addComponent(new GLTFShape('models/eventSpace/kpmg_events_main_geo_1.glb'))
        this.bankExitDoor.addComponent(new GLTFShape('models/eventSpace/kpmg_events_exit_door_1.glb'))
...
export const Event = new EventInstance()